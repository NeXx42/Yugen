        ...
        <div className="ViewPage">
            ...
            <div className="ViewPage_Container">
                <div className="ViewPage_Left" >
                    <div className="ViewPageContainer" id="ViewPage_EpisodeInfo" />
                    <div className="ViewPage_Info ViewPageContainer">
                        <div>
                            ...
                            <div className="ViewPage_Info_Controls">
                                ...
                                <a href="https://myanimelist.net/anime/32380" target="_blank" rel="noopener noreferrer" >
                ...
                <div className="ViewPage_Right">
                    {
                        (media.connectedMedia?.length ?? 0) > 1 && (
                            <div className="ViewPage_Seasons ViewPageContainer">
                                <h2>Related</h2>
                                {media.connectedMedia?.filter(a => a.card.aniListId !== media.id).sort((a, b) => (a.season ?? 0) - (b.season ?? 0)).map(m => <MediaCardHorizontal key={m.card.aniListId} card={m.card} season={m.season} />)}
                            </div>
